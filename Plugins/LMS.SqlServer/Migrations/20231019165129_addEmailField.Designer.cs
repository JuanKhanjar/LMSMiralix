...
namespace LMS.SqlServer.Migrations
{
    ...
    [Migration("20231019165129_addEmailField")]
            ...
            modelBuilder.Entity("LMS.BusinessCore.Entities.Customer", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            RegistrationDate = new DateTime(2023, 10, 19, 18, 51, 28, 841, DateTimeKind.Local).AddTicks(3712)
                        },
                        new
                        {
                            CustomerId = 2,
                            ...
                            RegistrationDate = new DateTime(2023, 10, 19, 18, 51, 28, 841, DateTimeKind.Local).AddTicks(3762)
                        });
                });
